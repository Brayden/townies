...
if(['set-tax','fund-project','feature-project','support-project'].includes(b.action)){const error=await civicAction(d,r,b,now);if(error)return json({error:error.error},error.status);}
