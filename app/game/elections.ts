...
export type ElectionState=ReturnType<typeof electionWindow>&{mayor:{id:string;name:string;cycle:string}|null;candidates:{id:string;name:string}[];myVote:string|null;nominated:boolean};
