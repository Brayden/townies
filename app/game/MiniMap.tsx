...
export default function MiniMap({data,getPosition,onVisit}:{data:TownState;getPosition:()=>{x:number;z:number}|undefined;onVisit:(id:string)=>void}){
