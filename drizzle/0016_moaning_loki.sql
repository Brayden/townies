...
CREATE INDEX `auth_account_user` ON `auth_accounts` (`user_id`);--> statement-breakpoint
CREATE UNIQUE INDEX `auth_provider_account` ON `auth_accounts` (`provider_id`,`account_id`);--> statement-breakpoint
